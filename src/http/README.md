...
- `alova 的 http`，路径（src/http/alova.ts），对应的示例在 src/api/demo.ts
- `vue-query`, 路径（src/http/vue-query.ts）, 目前主要用在自动生成接口，详情看(https://wangyue.tech/base/17-generate)，示例在 src/service/app 文件夹
